...
This directory contains the curated public-safe inputs for the future personal website implementation.

## Scope

- Public-safe only.
- No secrets, private CV material, or unsupported claims.
- No website application code.
...
- Read the manifest before using any approved source file.
